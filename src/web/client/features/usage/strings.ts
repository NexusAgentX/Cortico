...
const zh = {
  ...
  navGroup: '系统',
  pageTitle: '用量与成本',
  pageDesc: '查看模型调用、token、缓存与成本在所选时间范围内的变化。',
  bucketAuto: '自动',
  bucketMinute: '分',
  bucketHour: '时',
  bucketDay: '天',
  ...
  compEn: '钱花在哪',
  mainTitle: '用量时间序列',
  mainDesc: '拆分可多选叠加：同时选类型 + 角色，会把每个类型内部再按角色分开。',
  split: '拆分',
  dimType: '类型',
  dimRole: '角色',
  dimModel: '模型',
...
const en: typeof zh = {
  ...
  pageDesc: 'See how model calls, tokens, cache and cost change over the selected time range.',
  bucketAuto: 'Auto',
  bucketMinute: 'Minute',
  bucketHour: 'Hour',
  bucketDay: 'Day',
  ...
  compEn: 'where the money goes',
  mainTitle: 'Usage time series',
  mainDesc: 'Splits can be combined: selecting type + role splits each type further by role.',
  split: 'Split',
  dimType: 'Type',
  dimRole: 'Role',
  dimModel: 'Model',
  ...
  burned: (tok: string) => `burned ≈ ${tok} tok`,
