...
const zh = {
  ...
  languageDesc: '仅保存在当前浏览器，刷新页面后生效。服务端消息仍使用部署语言。',
  reloadTitle: '切换界面语言？',
...
const en: typeof zh = {
  ...
  language: '界面语言 / Language',
  languageDesc: 'Saved in this browser; takes effect after reloading. Server messages retain the deployment language.',
