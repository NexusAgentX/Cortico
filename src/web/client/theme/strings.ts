...
const zh = {
  ...
  schemeMint: '脑皮质薄荷',
  schemeMintNote: '灰调薄荷、藕紫与中性灰背景',
  schemeNavigator: '未来领航员',
  schemeNavigatorNote: '可缇 Corti 的海军蓝、天蓝与金，底色收在冷灰',
  schemeCrabDaisy: '螃蟹和雏菊',
  schemeCrabDaisyNote: 'Claude 网页的赤陶、蓝色与灰阶',
  customScheme: '自定义方案',
  customNote: '本机自定义配色',
...
const en: typeof zh = {
  ...
  schemeMintNote: 'Muted mint and mauve over neutral grey',
  schemeNavigator: 'Future Navigator',
  schemeNavigatorNote: 'Corti\'s navy, sky blue and gold over cool grey',
  schemeCrabDaisy: 'Crab & Daisy',
  schemeCrabDaisyNote: 'Claude web terracotta, blue and greys',
