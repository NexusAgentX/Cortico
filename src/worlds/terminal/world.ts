...
const zh = {
  ...
  moduleLabel: '终端对话',
  panelTitle: '对话',
  panelDescription: '直接和她说话,可以附图;消息与在场提示都走本 World 自己的流式通道。',
...
const en: typeof zh = {
  ...
  panelTitle: 'Chat',
  panelDescription: 'Talk to her directly, with optional images; messages and presence hints ride on this module\'s own stream.',
